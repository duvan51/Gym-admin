        ...
        <div className="flex min-h-screen bg-background-dark text-white font-display">
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                <header className="px-10 py-8 border-b border-border-dark bg-surface-dark/30 backdrop-blur-md flex justify-between items-center shrink-0">
                    <div>
                        <h1 className="text-4xl font-black uppercase italic tracking-tighter text-primary-blue">Contabilidad <span className="text-white">Avanzada</span></h1>
                ...
                <div className="flex-1 p-10 overflow-y-auto custom-scrollbar space-y-8 pb-20">
                    ...
                    <section className="bg-surface-dark border border-border-dark rounded-[2.5rem] p-8">
                        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                            ...
                            <div className="flex items-center gap-4 bg-background-dark/50 p-4 rounded-[2rem] border border-white/5">
                                <div className="flex flex-col px-4">
                                    ...
                                    <input
                                        ...
                                        className="bg-transparent text-lg font-black outline-none text-primary-blue"
                                    />
                                </div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                        ...
                        <div className="bg-surface-dark border border-border-dark rounded-[2.5rem] p-8 space-y-6">
                            <h3 className="text-xl font-black uppercase italic mb-4">Ingresos del Periodo</h3>
                            ...
                            <div className="space-y-4">
                                {[
                                    ...
                                    <div key={i} className="p-8 rounded-[2rem] bg-background-dark/30 border border-white/5">
                                        <div className="flex justify-between items-start mb-4">
                                            <div>
                                                <p className="text-[10px] font-black text-slate-500 uppercase tracking-widest leading-none mb-2">{row.period}</p>
                                                <h4 className="font-black text-3xl italic uppercase leading-none">{formatCOP(row.amount)}</h4>
                                            </div>
                        ...
                        <div className="bg-surface-dark border border-border-dark rounded-[2.5rem] p-8 space-y-6">
                            <div className="flex justify-between items-center mb-4">
                                <h3 className="text-xl font-black uppercase italic">Instantánea Diaria</h3>
                                <div className="text-[10px] font-black text-slate-500 uppercase bg-background-dark px-3 py-1 rounded-full">Fecha: {dateTo}</div>
                            </div>
                            ...
                            <div className="grid grid-cols-1 gap-6">
                                <div className="p-8 rounded-[2rem] bg-primary/5 border border-primary/20">
                                    ...
                                    <h4 className="text-4xl font-black italic">{formatCOP(stats.dailyRevenue)}</h4>
                                ...
                                <div className="p-8 rounded-[2rem] bg-primary-blue/5 border border-primary-blue/20">
                                    ...
                                    <h4 className="text-4xl font-black italic">{formatCOP(stats.dailyAccrued)}</h4>
                    ...
                    {/* Historical Helper */}
                    <div className="bg-background-dark/50 border border-white/5 rounded-[2.5rem] p-8 flex items-center justify-between">
                        <div className="flex items-center gap-6">
                            <div className="size-14 rounded-2xl bg-white/5 flex items-center justify-center text-slate-400">
                            ...
                            <div>
                                ...
                                <h4 className="text-2xl font-black italic">{formatCOP(stats.totalRevenue)}</h4>
                            </div>
                        </div>
