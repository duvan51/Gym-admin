            ...
            <main className="flex-1 p-10 overflow-y-auto">
                <header className="mb-12">
                    <h1 className="text-5xl font-black uppercase italic tracking-tighter">
                        Mi <span className="text-primary-blue">Suscripción</span>
                    </h1>
                    <p className="text-slate-500 font-bold uppercase tracking-widest mt-2">Gestiona el acceso de tu gimnasio a la plataforma</p>
                </header>
